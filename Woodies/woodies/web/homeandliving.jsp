    ...
    <body>
        ...
        <div class="relative">
            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-30 text-center">
                <h1 class="text-4xl font-bold text-white">Home & Living Shelves</h1>
                <p class="text-white text-sm mt-2">
                    <a href="home.jsp" class="hover:text-[#b68f2f]">Home</a> &gt; <span><a href="home.jsp" class="hover:text-[#b68f2f]">Category</a></span> &gt; <span>Home & Living Shelves</span>
                </p>
            </div>
        </div>
