...
<footer class="text-white py-8 w-full">
    <div class="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8 text-center">
    ...
    <hr class="h-px my-8 bg-gray-200 border-0 dark:bg-gray-400">
    <div class="py-0.1 text-gray-700 text-center">
        <p>© 2024 Woodies. All Rights Reserved.</p>
    </div>
</footer>
