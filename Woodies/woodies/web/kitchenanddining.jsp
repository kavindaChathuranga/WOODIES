    ...
    <body>
            ...
            <div class="bg-[#faf7f0] w-screen">
                <div class="container mx-auto px-6 py-4 flex justify-between items-center">
                    ...
                    <a href="home.jsp" class="inline-block transform transition duration-200 hover:scale-105 hover:shadow-md hover:opacity-90 active:scale-95">
                        <img src="resources/images/logo/woodies_logo.png" alt="Logo" class="h-10 w-auto" ml-10 />
                    </a>
                    <!-- Navigation list -->
        ...
        <div class="relative">
            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-30 text-center">
                <h1 class="text-4xl font-bold text-white">Kitchen & Dining Shelves</h1>
                <p class="text-white text-sm mt-2">
                    <a href="home.jsp" class="hover:text-[#b68f2f]">Home</a> &gt; <span><a href="home.jsp" class="hover:text-[#b68f2f]">Category</a></span> &gt; <span>Kitchen & Dining Shelves</span>
                </p>
            </div>
        </div>
