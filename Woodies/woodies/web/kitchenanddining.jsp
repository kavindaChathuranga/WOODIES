            ...
            <div class="container mx-auto px-6 py-4 flex justify-between items-center">
                ...
                <nav class="flex items-center space-x-6">
                    ...
                    <div class="relative dropdown" id="categoryDropdown">
                        <a href="#" class="text-yellow-500 bg-opacity-30 hover:text-yellow-500 bg-opacity-30 dropdown-text">CATEGORY</a>
                        <div
                            ...
                            <a href="kitchenanddining.jsp" class="block px-4 py-2 text-yellow-500 bg-opacity-30 hover:text-yellow-500 bg-opacity-30">Kitchen & Dining Shelves</a>
