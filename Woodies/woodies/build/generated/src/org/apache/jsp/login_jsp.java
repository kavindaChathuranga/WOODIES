...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    <img src=\"resources/images/login_signup_images/login.jpg\" alt=\"Sign In Image\" class=\"rounded-lg mb-8\"/>\n");
      ...
      out.write("                        <a href=\"signup.html\" class=\"rounded-full border-2 border-yellow-500 text-yellow-500 text-xs font-bold py-3 px-11 uppercase tracking-wide transition hover:bg-yellow-500 hover:text-white\">Sign Up</a>\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      out.write("\n");
      ...
      out.write("                        \n");
      out.write("                        <button class=\"rounded-full border border-yellow-500 bg-yellow-500 text-white text-xs font-bold py-3 px-11 uppercase tracking-wide transition hover:bg-yellow-600 mb-5\">Sign In</button>\n");
      out.write("                        \n");
      out.write("                        <span class=\"text-sm mb-2\">or use your account</span>\n");
      out.write("                        <div class=\"flex gap-2 my-5\">\n");
      out.write("                            <a href=\"#\" class=\"border border-yellow-200 rounded-full w-10 h-10 flex items-center justify-center transition hover:bg-yellow-200\"><i class=\"fab fa-facebook-f\"></i></a>\n");
